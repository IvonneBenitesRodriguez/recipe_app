...
```sh
  cd my-folder
  git clone git@github.com:IvonneBenitesRodriguez/recipe_app.git
```
...
Feel free to check the [issues page](https://github.com/IvonneBenitesRodriguez/recipe_app/issues).
